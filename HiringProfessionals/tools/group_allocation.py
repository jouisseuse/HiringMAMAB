...
def process_group_allocations(input_csv):
    ...
    # Process each player's allocation data
...
def process_exit_survey(input_csv):
    ...
    # Collect survey results per player
    survey_data = []
...
if __name__ == "__main__":
    ...
    print(f"Group allocation figures saved to: {os.path.join(os.path.dirname(input_csv), 'figures')}")
